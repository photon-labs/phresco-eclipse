...
public class ConsoleViewManager {
	...
	public void println(BufferedReader performAction) {		
		...
		newMessageConsoleStream.isActivateOnWrite();
		write(performAction, newMessageConsoleStream);
	}
	
	
	public void write(final BufferedReader performAction, final MessageConsoleStream newMessageConsoleStream) {
