...
public class TechnologyPage extends WizardPage implements IWizardPage {
	...
	public void createControl(Composite parent) {
		...
		Combo techCombo = new Combo(appComposite, SWT.NONE);
		...
		Combo versionCombo = new Combo(appComposite, SWT.NONE);
		...
		Combo webLayerCombo = new Combo(webComposite, SWT.NONE);
		...
		Combo webWidgetCombo = new Combo(webComposite, SWT.NONE);
		...
		Combo webVersionCombo = new Combo(webComposite, SWT.NONE);
